...
This is a thesis project for a CS major: the point is not to build a tool, but to *demonstrate understanding* of compiler architecture and static analysis by rebuilding a piece of Rust's core idea from scratch.
